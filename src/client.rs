...
use crate::c_ar::{
    control_client::ControlClient, handshake_message::Msg, HandshakeMessage, NotifyDescription,
    SdpType,
};
...
impl ClientArgs {
    pub async fn run(self) -> Result<(), Box<dyn Error>> {
        ...
        tx.send(HandshakeMessage {
            msg: Some(Msg::Description(notify_description)),
        })?;
        response_reader_handle
            .await?
